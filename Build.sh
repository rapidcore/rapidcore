...
&& dotnet test src/core/test-functional/functionaltests.csproj -c Release -f netcoreapp2.0
...
&& dotnet test src/mongo/test-functional/functionaltests.csproj -c Release -f netcoreapp2.0
...
&& dotnet test src/postgresql/test-functional/functionaltests.csproj -c Release -f netcoreapp2.0
...
&& dotnet test src/redis/test-functional/functionaltest.csproj -c Release -f netcoreapp2.0

# Build xunit extensions and test
dotnet build -c Release -f netstandard1.6 src/xunit/main/rapidcore.xunit.csproj \
&& dotnet test src/xunit/test-unit/unittests.csproj -c Release -f netcoreapp2.0
